...
def main():
    ...
    try:
        ...
        if camera.has_filter_wheel():
            ...
            if current_pos_status.is_success:
                ...
                if current_pos != 1:
                    ...
                    print(f"Filter move status: {filter_status.level.value.upper()} - {filter_status.message}")
                else:
        ...
        print(f"Disconnect status: {disconnect_status.level.value.upper()} - {disconnect_status.message}")
