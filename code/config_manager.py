...
class ConfigManager:
    ...
    def _get_default_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "plate_solve": {
                ...
                "platesolve2": {
                    "executable_path": (
                        "C:/Program Files (x86)/PlaneWave Instruments/PWI3/PlateSolve2/"
                        "PlateSolve2.exe"
                    ),
                ...
                "astrometry": {"api_key": "", "api_url": "http://nova.astrometry.net/api/"},
            },
            "overlay": {
                ...
                "update": {"update_interval": 30, "max_retries": 3, "retry_delay": 5},
                "display": {
    ...
    def get_mount_config(self) -> Dict[str, Any]:
        ...
        """
        return cast(Dict[str, Any], self.config.get("mount", {}))
    ...
    def get_camera_config(self) -> Dict[str, Any]:
        ...
        return cast(Dict[str, Any], camera_config)
    ...
    def get_video_config(self):
        ...
        warnings.warn(
            "get_video_config() is deprecated, use get_frame_processing_config() instead",
            DeprecationWarning,
            stacklevel=2,
        )
        # Back-compat: some tests expect 'ascom' settings under video config
        vc: Dict[str, Any] = dict(self.get_frame_processing_config())
        try:
            vc["ascom"] = cast(Dict[str, Any], self.get_camera_config().get("ascom", {}))
        except Exception:
            vc["ascom"] = {}
        return vc
    ...
    def get_plate_solve_config(self) -> Dict[str, Any]:
        ...
        """
        return cast(Dict[str, Any], self.config.get("plate_solve", {}))
    ...
    def get_overlay_config(self) -> Dict[str, Any]:
        ...
        """
        return cast(Dict[str, Any], self.config.get("overlay", {}))
    ...
    def get_streaming_config(self) -> Dict[str, Any]:
        ...
        """
        return cast(Dict[str, Any], self.config.get("overlay", {}).get("update", {}))
    ...
    def get_display_config(self) -> Dict[str, Any]:
        ...
        """
        return cast(Dict[str, Any], self.config.get("overlay", {}).get("display", {}))
    ...
    def get_logging_config(self) -> Dict[str, Any]:
        ...
        """
        return cast(Dict[str, Any], self.config.get("logging", {}))
    ...
    def get_platform_config(self) -> Dict[str, Any]:
        ...
        """
        return cast(Dict[str, Any], self.config.get("platform", {}))
    ...
    def get_advanced_config(self) -> Dict[str, Any]:
        ...
        """
        return cast(Dict[str, Any], self.config.get("advanced", {}))
    ...
    def save_default_config(self, path: Optional[str] = None) -> None:
        ...
        try:
            with open(path, "w", encoding="utf-8") as file:
                yaml.dump(
                    self._get_default_config(), file, default_flow_style=False, allow_unicode=True
                )
