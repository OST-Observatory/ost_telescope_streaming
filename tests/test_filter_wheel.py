    ...
    try:
        ...
        if has_filter_wheel:
            ...
            if filter_names_status.is_success:
                ...
                print_test_result(False, f"Failed to get filter names: {filter_names_status.message}")
            ...
            if filter_pos_status.is_success:
                ...
                print_test_result(False, f"Failed to get filter position: {filter_pos_status.message}")
            ...
            if filter_names_status.is_success and len(filter_names) > 1:
                ...
                if set_pos_status.is_success:
                    ...
                    if verify_pos_status.is_success:
                        ...
                        print_test_result(False, f"Failed to verify position: {verify_pos_status.message}")
                else:
