        ...
        if connect_status.is_success:
            ...
            if camera2.has_cooling():
                ...
                if cooling_status.is_success:
                    ...
                    if (
                        info["temperature"] == camera2.last_cooling_info["temperature"]
                        and info["cooler_power"] == camera2.last_cooling_info["cooler_power"]
                        and info["cooler_on"] == camera2.last_cooling_info["cooler_on"]
                    ):
