...
def test_direct_alpyca():
    ...
    try:
        ...
        properties_to_test = [
            ...
            "PixelSizeX", "PixelSizeY", "MaxADU", "ElectronsPerADU", "FullWellCapacity",
            
            # Exposure properties
            "ExposureMin", "ExposureMax", "ExposureResolution",
            "LastExposureDuration", "LastExposureStartTime", "ImageReady", "CameraState", "PercentCompleted",
            
            # Binning properties
            "BinX", "BinY", "MaxBinX", "MaxBinY", "CanAsymmetricBin",
            
            # Cooling properties
            "CanSetCCDTemperature", "CanGetCoolerPower", "CCDTemperature", 
            "SetCCDTemperature", "CoolerOn", "CoolerPower", "HeatSinkTemperature",
            ...
            # Readout properties
            "ReadoutMode", "ReadoutModes", "CanFastReadout", "FastReadout"
        ]
        ...
        if failed_properties:
            ...
            unknown_errors = [p for p, e in failed_properties if "Property Unknown is not implemented" in e]
            if unknown_errors:
...
def main():
    ...
    if not all_success:
        ...
        print(f"   These properties should be handled with try-catch in the wrapper.")
